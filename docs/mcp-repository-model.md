...
- Over-threshold files (`>1200` LOC) return `context_available: "degraded"` under the code-index response-size guard, unchanged. This inventory/context threshold is unrelated to worker-admission policy and produces no admission verdict.
