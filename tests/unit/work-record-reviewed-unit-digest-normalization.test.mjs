    ...
    slices: [
      {
        id: SLICE_ID,
        work_kind: "implementation",
        write_scope: ["tests/unit/work-record-reviewed-unit-digest-normalization.test.mjs"],
        repo_paths: ["tests/unit/work-record-reviewed-unit-digest-normalization.test.mjs"],
        scenarios: scenarios(),
        ...sliceOverrides
      }
    ],
