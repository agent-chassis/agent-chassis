# Cross-representation result-shape parity proof pack 1.0.0

`proof.result-shape.cross-representation-parity@1.0.0` is the v0.34
structural profile for checking parity between two caller-declared result
representations of one declared logical source.
...
The bespoke adequacy module exercises JSON-versus-protobuf, SQL-row-versus-search-
document, and CLI-table-versus-JSON domains. It kills missing and extra members,
