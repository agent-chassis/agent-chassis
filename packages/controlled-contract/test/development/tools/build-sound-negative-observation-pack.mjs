...
} from "../../proof-packs/sound-negative-observation-v1-fixture.mjs";
import {
  buildSoundNegativeObservationDeclaration,
  buildSoundNegativeObservationEvaluationInput,
  buildSoundNegativeObservationProfile
} from "../../proof-packs/sound-negative-observation-v1-profile.mjs";
import {
  EXCLUSIONS,
  GUARANTEE
} from "../../proof-packs/sound-negative-observation-v1-constants.mjs";
import {
  CONTROL_IDS,
  runExactBindingCertificationControls
} from "../../proof-packs/sound-negative-observation-v1-exact-corpus.mjs";
import {
  runProofPackAdequacyControls
} from "../../proof-packs/sound-negative-observation-v1-adequacy.mjs";

const packageRoot = path.resolve(fileURLToPath(new URL("../../../", import.meta.url)));
const repositoryRoot = path.resolve(packageRoot, "../..");
const certificationDirectory = path.join(
  packageRoot, "test", "certification", "profiles",
  "proof.observation.sound-negative", "1.0.0"
);
...
const adequacyModule = path.join(
  packageRoot, "test", "proof-packs", "sound-negative-observation-v1-adequacy.mjs"
);
...
const exactModule = path.join(
  packageRoot, "test", "proof-packs", "sound-negative-observation-v1-exact-corpus.mjs"
);
const exactCertification = {
  ...
  corpus: {
    corpus_id: "proof-observation-sound-negative-exact-binding",
